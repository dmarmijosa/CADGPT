# Deploy a CAD Engine server before distributing agents
...
5. Sign in as the same CAD Engine account that approved the device. Consent to the requested permissions.
